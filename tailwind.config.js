...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        // Off Script Brand Colors - PRIORITY
        'primary-black': '#000000',
        'primary-white': '#ffffff', 
        'primary-blue': '#8cc9ff',
        'primary-peach': '#fdc0a8',
        
        // Street Art Palette - HIGH PRIORITY
        ...
        // Legacy shadcn colors - LOWER PRIORITY
        border: "#e5e7eb", // neutral-200 equivalent
        input: "#f3f4f6", // neutral-100 equivalent  
        ring: "#374151", // neutral-700 equivalent
