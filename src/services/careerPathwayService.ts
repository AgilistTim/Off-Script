    ...
    try {
      ...
      const guidanceData: ThreadCareerGuidance = {
        ...
        guidance: {
          ...
          primaryPathway: {
            // Store complete comprehensive career data - preserve original MCP-generated data
            ...careerCards[0],
          ...
          alternativePathways: careerCards.slice(1).map((card, index) => ({
            // Preserve original comprehensive data from MCP
            ...card,
            id: card.id || `alt-${Date.now()}-${index}`,
