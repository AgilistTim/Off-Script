      ...
      >
        ...
        >
          ...
          {isAssistant && message.metadata && (
            <div className="flex items-center space-x-2 mb-2 text-xs text-primary-black/60">
          ...
          <div className={`flex items-center justify-between mt-2 text-xs ${
            isUser ? 'text-primary-black/60' : 'text-primary-black/60'
          }`}>
              ...
              <motion.button
                ...
                className={`flex items-center space-x-1 p-1 rounded ${
                  isPlayingAudio 
                    ...
                    : 'hover:bg-primary-black/10 text-primary-black/60'
                } transition-colors`}
          ...
          {message.metadata?.actionRequired && (
            <motion.div
              className="mt-3 p-2 bg-primary-mint border border-primary-green/30 rounded-lg text-xs text-primary-black"
