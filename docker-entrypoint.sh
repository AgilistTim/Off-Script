...
echo "  VITE_PERPLEXITY_API_KEY: ${VITE_PERPLEXITY_API_KEY:-NOT_SET} (redacted)"
...
# Use safe variable expansion to prevent undefined variables from creating empty strings
sed -i "s|__FIREBASE_API_KEY__|${VITE_FIREBASE_API_KEY:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__FIREBASE_AUTH_DOMAIN__|${VITE_FIREBASE_AUTH_DOMAIN:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__FIREBASE_PROJECT_ID__|${VITE_FIREBASE_PROJECT_ID:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__FIREBASE_STORAGE_BUCKET__|${VITE_FIREBASE_STORAGE_BUCKET:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__FIREBASE_MESSAGING_SENDER_ID__|${VITE_FIREBASE_MESSAGING_SENDER_ID:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__FIREBASE_APP_ID__|${VITE_FIREBASE_APP_ID:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__FIREBASE_MEASUREMENT_ID__|${VITE_FIREBASE_MEASUREMENT_ID:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__YOUTUBE_API_KEY__|${VITE_YOUTUBE_API_KEY:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__RECAPTCHA_SITE_KEY__|${VITE_RECAPTCHA_SITE_KEY:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__OPENAI_API_KEY__|${VITE_OPENAI_API_KEY:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__ELEVENLABS_API_KEY__|${VITE_ELEVENLABS_API_KEY:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__ELEVENLABS_AGENT_ID__|${VITE_ELEVENLABS_AGENT_ID:-NOT_SET}|g" "$ENV_FILE"
sed -i "s|__PERPLEXITY_API_KEY__|${VITE_PERPLEXITY_API_KEY:-NOT_SET}|g" "$ENV_FILE"
...
# Add missing MCP_SERVER_URL replacement
sed -i "s|__MCP_SERVER_URL__|${VITE_MCP_SERVER_URL:-NOT_SET}|g" "$ENV_FILE"
